<script>
    ...
    $: playlists = liveQuery(() => db.playlist.toArray());
</script>
...
<div class="outer-card">
    <div class="card_vert">
        <div class="img_container">
            ...
            <svg class="play_hover" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{#if $playlists}
    {#each $playlists as playlist}
        <LargeSongCard title={playlist.title} artist="" albumArt={playlist.playlistArt} type="playlist" />
    {/each}
{/if}
