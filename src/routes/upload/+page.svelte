      ...
      <div class="welcome2">
        {#if working == true}
          ...
          {#if working2 == false && working == true}
            ...
            <button on:click={(window.location.href = '/settings')}>
              Use External
            </button>
            <p>
              Press the Use External button to set an external location to load
              songs from
            </p>
  ...
  {:else}
    <div class="welcome">
      <div class="welcome2">
        ...
        <p>
          To get started, click the button below to upload your music library!
        </p>
