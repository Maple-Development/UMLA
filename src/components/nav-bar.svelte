...
<div class="nav-bar">
    ...
    <div class="library">
         <div class="library_icon">
             ...
             <path id="Vector" d="M24.3 0H8.1C6.615 0 5.4 1.305 5.4 2.9V20.3C5.4 21.895 6.615 23.2 8.1 23.2H24.3C25.785 23.2 27 21.895 27 20.3V2.9C27 1.305 25.785 0 24.3 0ZM20.25 7.25H17.55V15.0365C17.55 16.878 16.335 18.5745 14.634 18.8065C12.3525 19.14 10.4355 16.994 10.854 14.529C11.124 12.934 12.447 11.7015 13.959 11.6C14.8095 11.542 15.579 11.832 16.2 12.3395V5.8C16.2 5.0025 16.8075 4.35 17.55 4.35H20.25C20.9925 4.35 21.6 5.0025 21.6 5.8C21.6 6.5975 20.9925 7.25 20.25 7.25ZM1.35 5.8C0.6075 5.8 0 6.4525 0 7.25V26.1C0 27.695 1.215 29 2.7 29H20.25C20.9925 29 21.6 28.3475 21.6 27.55C21.6 26.7525 20.9925 26.1 20.25 26.1H4.05C3.3075 26.1 2.7 25.4475 2.7 24.65V7.25C2.7 6.4525 2.0925 5.8 1.35 5.8Z" fill="#81F0FF"/>
             </svg>
         </div>
    ...
    <div class="playlists">
           <div class="playlist_icon">
                <svg viewBox="0 0 27 29" fill="none" xmlns="http://www.w3.org/2000/svg%22%3E">
                <g id="Group">
                <path id="Vector" d="M1.8 3.625H10.8C11.7941 3.625 12.6 2.81345 12.6 1.8125C12.6 0.811434 11.7941 0 10.8 0H1.8C0.805952 0 0 0.811434 0 1.8125C0 2.81345 0.805952 3.625 1.8 3.625Z" fill="#81F0FF"/>
                <path id="Vector_2" d="M1.8 9.0625H10.8C11.7941 9.0625 12.6 8.25095 12.6 7.25C12.6 6.24893 11.7941 5.4375 10.8 5.4375H1.8C0.805952 5.4375 0 6.24893 0 7.25C0 8.25095 0.805952 9.0625 1.8 9.0625Z" fill="#81F0FF"/>
                <path id="Vector_3" d="M12.6 12.6875C12.6 11.6864 11.7941 10.875 10.8 10.875H1.8C0.805952 10.875 0 11.6864 0 12.6875C0 13.6885 0.805952 14.5 1.8 14.5H10.8C11.7941 14.5 12.6 13.6885 12.6 12.6875Z" fill="#81F0FF"/>
                <path id="Vector_4" d="M22.2373 4.29982C21.2087 3.50067 19.8001 2.40592 19.8001 1.8125C19.8001 0.811547 18.9941 0 18 0C17.006 0 16.2 0.811547 16.2 1.8125V18.4411C15.6363 18.24 15.0322 18.125 14.4 18.125C11.4177 18.125 9.00003 20.5594 9.00003 23.5625C9.00003 26.5656 11.4177 29 14.4 29C17.3824 29 19.8001 26.5656 19.8001 23.5625V6.98339C19.8796 7.04536 19.9587 7.10817 20.038 7.16991C22.0689 8.74746 23.4001 9.89308 23.4001 11.3786C23.4001 13.6876 22.1803 14.9762 22.1454 15.0129C21.4326 15.7107 21.4163 16.8581 22.1093 17.5759C22.4622 17.9414 22.9309 18.125 23.4002 18.125C23.8522 18.125 24.3048 17.9546 24.6547 17.6121C24.8949 17.3772 27 15.2058 27 11.3785C27.0001 8.00049 24.3592 5.94857 22.2373 4.29982Z" fill="#81F0FF"/>
                </g>
                </svg>
           </div>
    ...
    <div class="profile">
      <div id="type-dark" class="refresh_icon">
        <svg fill="#81F0FF" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
     viewBox="0 0 489.533 489.533" xml:space="preserve">
        <g>
          <path fill="#81F0FF" d="M268.175,488.161c98.2-11,176.9-89.5,188.1-187.7c14.7-128.4-85.1-237.7-210.2-239.1v-57.6c0-3.2-4-4.9-6.7-2.9
