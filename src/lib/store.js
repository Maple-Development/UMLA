...
if (browser) {
    ...
    libraryLocation = localStorage.getItem('libraryLocation') ? JSON.parse(localStorage.getItem('libraryLocation')) : "local";
    playlists1 = localStorage.getItem('playlists') ? JSON.parse(localStorage.getItem('playlists')) : [];
}
